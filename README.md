...
|-------|---------|--------|--------------|------|
| Primitives | @yowazi/singi | "msingi" - foundation | Terminal I/O: ANSI, raw mode, input decoding | 0.1.0 (color exports added) |
| Styling | @yowazi/rangi | "rangi" - color, paint | Visual styling: colors, text attributes, semantic themes, box model, composition | 0.1.0 (ready) |
